...
3.  The odds of being in the category 2 vs Category 1 will decrease by 1.29 if moving from 0 to 1 for X2

4.  using similar calcuation as in point 2, The odds of being in category 2 vs Category 1 are \~73% lower if X2 is 1 as compared to 0.
...
2.  Independence: is verified by study design or domain knowledge

### 4.4.2 Model Fit

To assess the model fit we use metric based on the likelihood like **Deviance** and **AIC** which can be viewed in the model summary as explained in section 4.3
